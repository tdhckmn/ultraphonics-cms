...
export function ExampleCMSView() {
    ...
    const githubLink = (
        <Tooltip title="Get the source code of this example view">
            <IconButton
                href={
                    "https://github.com/FireCMSco/firecms/blob/master/example/src/SampleApp/ExampleCMSView.tsx"
                }
                    ...
                    <Grid container rowSpacing={5} columnSpacing={2}>
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            >
                                <CardContent sx={{ flexGrow: 1 }}>
                                    <Typography>Use this button to open a snackbar</Typography>
                                </CardContent>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Card variant="outlined" sx={{ height: "100%" }}>
                                <CardContent>
                                    <Typography>
                                        Use this button to open an entity in a custom path with a
                                        custom schema
                                    </Typography>
                                </CardContent>
