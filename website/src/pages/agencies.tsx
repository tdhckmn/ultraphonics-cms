...
function Agencies() {
    return (
        <Layout
            title={"FireCMS for Agencies: Deliver Faster, Impress Clients"}
            description="Build custom admin panels & CMS for your clients efficiently with FireCMS. Reduce development time, enhance client satisfaction, and scale your agency's offerings."
        >
            <Head>
                ...
                <main className="flex-grow">
                        ...
                        subtitle={
                            <>
                                <p className="text-xl md:text-2xl mb-4">
                                    Empower your agency to build robust, custom admin panels and CMS
                                    solutions
                                    <b> efficiently</b>. Delight clients, streamline workflows, and
                                    boost profitability.
                                </p>
                            </>
                        }
                    ...
                    <Panel color={"lighter"}>
                        <div className="p-4">
                            ...
                            <p className="text-xl md:text-2xl mb-4">
                                Client demands are high, timelines are tight. Building custom
                                back-office solutions from scratch eats into margins and slows down
                                delivery.
                            </p>
                            <p className="text-lg">
                                FireCMS provides a powerful, flexible foundation. Build bespoke
                                admin interfaces and CMS tailored to client needs in a fraction of
                                the time, freeing up your developers for complex features.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-24">
                            ...
                            <div className={"p-6 rounded-xl border bg-white " + defaultBorderMixin}>
                                ...
                                <p className="text-gray-700">
                                    Launch client admin panels significantly faster using pre-built
                                    components and schema inference. Reduce boilerplate code.
                                </p>
                            </div>
                            ...
                            <div className={"p-6 rounded-xl border bg-white " + defaultBorderMixin}>
                                ...
                                <p className="text-gray-700">
                                    Tailor every aspect to client requirements – custom fields,
                                    views, logic, branding. Deliver truly bespoke solutions.
                                </p>
                            </div>
                            ...
                            <div className={"p-6 rounded-xl border bg-white " + defaultBorderMixin}>
                                ...
                                <p className="text-gray-700">
                                    Provide clients with intuitive, easy-to-use interfaces they can
                                    manage themselves, reducing your support load.
                                </p>
                            </div>
                        </div>
                    </Panel>
                    ...
                    <Panel color={"gray"}>
                        <div className="max-w-5xl mx-auto py-16 px-4">
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div
                                    className={
                                        "p-5 rounded-lg border bg-gray-900 " + defaultBorderMixin
                                    }
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Build custom fields and views once, reuse across
                                                client projects.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Easily customize branding and themes to match client
                                                identity (especially with PRO).
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Define precise roles and access control for
                                                different client users.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Integrates smoothly with Firebase/GCP or self-host
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Leverages React and TypeScript for a familiar and
...
const showcaseData = [
    {
        ...
        challenge:
            "Needed a custom admin panel to manage products, orders, and customer data integrated with their existing Shopify backend.",
        solution:
            "Used FireCMS with custom actions and views to create a tailored interface, pulling data via APIs.",
    ...
    },
    {
        ...
        challenge:
            "Required an internal tool for the support team to manage user accounts, subscriptions, and feature flags.",
        solution:
            "Deployed FireCMS connected to their Firestore database, using role-based access for different support tiers.",
    ...
    },
    {
        ...
        challenge:
            "Client needed an easy way for non-technical marketers to update blog posts, case studies, and landing pages.",
        solution:
            "Set up FireCMS with predefined content schemas and markdown editors, enabling easy content updates.",
    ...
    },
    {
        ...
        challenge:
            "Needed a simple CRM to track client projects, communication logs, and assigned tasks.",
        solution:
            "Built a custom CRM interface using FireCMS collections for clients, projects, and logs with relations.",
                        ...
                        >
                            ...
                            <div className="flex-grow mb-4">
                                ...
                                <p className="text-sm text-white">
                                    <b>FireCMS Solution:</b> {item.solution}
                                </p>
                            </div>
                            {/* Replaced emoji with CheckCircleIcon */}
                            <div
                                className={
                                    "mt-auto pt-4 border-t flex items-start " + defaultBorderMixin
                                }
                            >
                                <CheckCircleIcon
                                    size={"smallest"}
