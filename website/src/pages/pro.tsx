            ...
            <div className="flex flex-col min-h-screen">
                <main className="flex-grow">
                    ...
                    <Panel color={"light_gray"} includeMargin={false}>
                        <div
                            className={
                                "max-w-7xl text-2xl md:text-5xl font-bold tracking-tight uppercase font-mono"
                            }
                        >
                            <p>
                                FireCMS PRO was crafted through collaboration with various{" "}
                                <strong>companies</strong>, out of the need to have a CMS that could
                                be used in <strong>different scenarios</strong> and that could be
                                easily customized to fit different needs.
                            </p>
                        </div>
                    </Panel>
                    ...
                    >
                        ...
                        <div className={"flex flex-col items-center"}>
                            <div
                                className={
                                    "items-center select-all font-mono text-gray-800 p-4 px-6 bg-gray-200 border-gray-300 border-solid w-fit text-md font-bold inline-flex rounded-md"
                                }
                            >
