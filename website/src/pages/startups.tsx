                ...
                <main className="flex-grow">
                        ...
                        subtitle={
                            <>
                                <p className="text-xl md:text-2xl mb-4">
                                    Get your startup&#39;s admin panel and content management up{" "}
                                    <b>in hours, not weeks</b>. Focus on your product, we handle
                                    your back-office.
                                </p>
                            </>
                        }
                    ...
                    <Panel color={"lighter"}>
                        <div className="p-4">
                            ...
                            <p className="text-xl md:text-2xl mb-4">
                                Startups juggle time, budget, and dev power. Building internal tools
                                drains focus from your core product. Generic tools often fall short
                                or get pricey.
                            </p>
                            <p className="text-lg">
                                FireCMS gives you enterprise-grade tooling without the overhead.
                                Empower your small team to deliver powerful admin interfaces while
                                engineers build what matters most.
                            </p>
                        </div>

                        <div className="rounded-xl border overflow-hidden shadow-md mt-8 mb-24">
                            <img
                                src={UsersImage}
                    ...
                    <Panel color={"light"} includePadding={true}>
                        <div className="max-w-5xl mx-auto text-center mb-12">
                            ...
                            <p className="text-xl">
                                Accelerate development without sacrificing quality. FireCMS is
                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-24">
                            ...
                            <div
                                className={
                                    "p-6 rounded-xl border shadow-sm bg-white " + defaultBorderMixin
                                }
                            >
                                <RocketLaunchIcon className="w-10 h-10 mb-3 text-green-600" />
                                <h3 className="text-xl font-bold mb-2">Launch in minutes</h3>
                                <p className="text-gray-700">
                                    Set up powerful CMS/admin panels rapidly via UI or schema. No
                                    backend coding needed for Firebase/MongoDB.
                                </p>
                            </div>
                            {/* Card 2: Scale */}
                            <div
                            ...
                            >
                                ...
                                <p className="text-gray-700">
                                    From MVP to unicorn, FireCMS scales effortlessly on
                                    Firebase/MongoDB&#39;s serverless infrastructure. No ops
                                    headaches.
                                </p>
                            </div>
                            {/* Card 3: Flexibility */}
                            ...
                            >
                                ...
                                <p className="text-gray-700">
                                    Use low-code options for speed, or customize deeply with React.
                                    Empower non-tech teams to manage data.
                                </p>
                            </div>
                        </div>
                    </Panel>
                            ...
                            right={
                                <div className="p-4">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="m-0 text-3xl font-bold">Built for Pivots</h3>
                                    </div>
                                    <p className="text-xl md:text-2xl mb-4">
                                        Startups evolve. Your tools should too. FireCMS makes
                                        adapting your data models easy.
                                    </p>
                                    <ul className="text-lg space-y-2 list-disc list-inside">
                                        <li>
                                            <b>Change schemas, add content types,</b> or restructure
                                            without rebuilding.
                                        </li>
                                        <li>
                                            Adapts to your <b>existing database structure</b> -
                                            great for ongoing projects.
                                        </li>
                                        <li>
                                            Headless architecture <b>decouples backend/frontend </b>
                                            for flexibility (web, mobile, multi-channel).
                                        </li>
                                        <li>
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold mb-1">
                                                Firebase/MongoDB Native
                                            </h3>
                                            <p className="text-sm text-gray-100">
                                                Leverages their real-time sync, security, and
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Focus on features, not infrastructure (with
                                                Firebase/MongoDB).
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Visual building & auto-detection adapt to your data
                                                fast.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Spreadsheet & form views, file storage, references,
                                                and more.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Configure views and permissions per user role
                                                easily.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Add custom fields, logic, hooks, and full React
                                                views.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Seamlessly manage nested data structures.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Live data sync across the CMS for collaboration.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-100">
                                                Transparency, community, and no vendor lock-in for
                                                essentials.
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <Panel color={"white"} includePadding={true}>
                        <div className="max-w-5xl mx-auto text-center py-12 px-4">
                            ...
                            <p className="text-xl mb-8">
                                Extend FireCMS to build the custom internal tools your startup
                                needs:
                            </p>
                            <ul className="text-left mx-auto max-w-2xl text-lg space-y-4">
                                <li className="flex items-start">
                                    ...
                                    <span>
                                        <b>Internal Tools:</b> Tailored dashboards for support, ops,
                                        sales, or data admin on your backend.
                                    </span>
                                </li>
                                <li className="flex items-start">
                                    <ArticleIcon className="w-5 h-5 mr-3 text-green-500 flex-shrink-0 mt-1" />
                                    <span>
                                        <b>Headless Content:</b> Manage content for web/mobile apps,
                                ...
                                <li className="flex items-start">
                                    ...
                                    <span>
                                        <b>User Management:</b> View, edit, and manage user profiles
                                        and permissions.
                                    </span>
                                </li>
                                <li className="flex items-start">
                                    ...
                                    <span>
                                        <b>Product/E-commerce Data:</b> Manage catalogs, variants,
                                        pricing, inventory easily.
                                    </span>
                                </li>
                                <li className="flex items-start">
                                    <SettingsApplicationsIcon className="w-5 h-5 mr-3 text-yellow-500 flex-shrink-0 mt-1" />
                                    <span>
                                        <b>App Configuration:</b> Control settings, feature flags,
                                        or A/B tests via a UI.
                                    </span>
                                </li>
                            </ul>
