...
export function UsageExamples() {
    ...
    const parallaxOffset =
        easeInOut(Math.max(0, Math.min(1, (400 + currentTop / 2) / offsetHeight))) * 2 - 1;
    ...
    return (
        <Panel
            ...
            className={clsx(
                "relative flex flex-col items-center justify-center bg-gradient-to-b from-white to-gray-200"
            )}
        >
            <LinedSpace position={"bottom"} size={"larger"} />

            <div className={"relative max-w-full w-[84rem] mx-auto"} style={{ height: 900 }}>
                {/* MM CMS */}
                <BrowserFrame
                    style={{
                    ...
                    className={"absolute z-20 w-[360px] md:w-[540px] bg-gray-900 max-w-[80vw]"}
                >
                    <video
                        style={{
                            pointerEvents: "none",
                ...
                <BrowserFrame
                    ...
                    className={"absolute z-10 md:w-[800px] bg-gray-900"}
                >
                ...
                <BrowserFrame
                    ...
                    className={"absolute z-30 w-96 md:w-[720px] bg-gray-100"}
                >
                    <img
                        loading="lazy"
                        src={editorWhite}
                ...
                {/* TPA APP */}
                <div
                    className="absolute top-64 z-30"
                    style={{
                        top: 400,
