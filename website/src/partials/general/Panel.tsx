...
export function Panel({
        ...
        color === "transparent"
            ...
            : color === "white"
              ...
              : color === "white-to-slate"
                ? "bg-gradient-to-b from-white to-slate-50 text-text-primary"
                : color === "light"
                  ? "bg-gray-200 text-text-primary"
                  : color === "light-to-white"
                    ? "bg-gradient-to-b from-gray-100 to-white text-text-primary"
                    : color === "lighter"
                        ...
                        : color === "gray"
                          ...
                          : color === "dark_gray"
                            ...
                            : color === "primary"
                              ...
                              : color === "dataki"
                                ? "bg-blue-950 text-white dark:text-white"
                                : color === "secondary"
    ...
    const borderClass =
        color === "primary"
            ? "border-solid border-white border-opacity-20 dark:border-opacity-20"
            : defaultBorderMixin;
    ...
    return (
        <section
            ref={ref}
            className={clsx(
                "max-w-full relative flex flex-col items ",
                colorClass,
                includeMargin ? " my-16" : "",
                "border-0 border-t",
                defaultBorderMixin,
