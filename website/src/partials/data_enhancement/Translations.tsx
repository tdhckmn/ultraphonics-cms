    ...
    return (
        <Panel color={"light_gray"}>
            <TwoColumns
                left={
                    <>
                        <h2 className={"h2"}>Are you managing translations?</h2>
                        <p className="text-xl">
                            Translate your content to any language with the click of a button.
                        </p>
                        <p className="text-xl">
                            Let FireCMS handle the translation for you. You can then edit the
                            generated content and save it to your database.
                        </p>
                        <p className="text-xl">
