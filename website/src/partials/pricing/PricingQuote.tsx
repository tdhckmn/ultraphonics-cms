...
export function PricingQuote() {
    ...
    const { quote, author, avatar, role } = ikeaQuote;
    return (
        <>
            <Panel
                ...
                <div className={ContainerInnerPaddingMixin}>
                    ...
                    >
                        ...
                        <img
                            ...
                            alt={author}
                        />
                        <cite className="not-italic	block mt-4 text-md font-bold uppercase text-center">
                            ~ {author}
                        </cite>
                        <cite className="not-italic	block mt-2 text-sm font-bold uppercase text-center">
                            {role}
                        </cite>
                    </div>
                </div>
