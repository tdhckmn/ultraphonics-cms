...
export function FireCMSCloudVersions() {
    const communityTier = (
        <div
            className={clsx(
                "bg-white w-full max-w-xl lg:max-w-none h-full p-6 border rounded-lg  flex flex-col",
                defaultBorderMixin
            )}
        >
            ...
            <div className={"grow mt-4"}>
                <ul className={"pl-4"}>
                    ...
                    <li className={"list-disc ml-2"}>
                        <Tip
                            tip={
                                "Change your logo, theme, colors, fonts, home page, form fields, custom views..."
                            }
                        >
    ...
    const cloud = (
        <div
            className={clsx(
                "bg-white w-full max-w-xl lg:max-w-none h-full p-6 rounded-lg flex flex-col outline-none ring-2 ring-primary ring-opacity-75 ring-offset-2 ring-offset-transparent"
            )}
        >
            <h3 className={"text-3xl md:text-4xl font-bold   my-2"}>FireCMS Cloud</h3>
            <p className={"text-lg mb-4 font-bold h-16"}>
            ...
            <div className={"flex flex-row gap-4 my-6"}>
                <a
                    className={
                        "h-fit text-sm btn btn-sm py-2 px-3 text-white bg-primary  hover:bg-blue-700  hover:text-white uppercase border-solid rounded "
                    }
            ...
            <div className={"grow"}>
                <ul className={"pl-4"}>
                    ...
                    <li className={"list-disc ml-2"}>
                        <Tip
                            tip={
                                "Customise your views, form fields, navigation routes, custom views and more, using module federation"
                            }
                        >
                            Custom code
                        </Tip>
                    ...
                    <li className={"list-disc ml-2"}>
                        <Tip
                            tip={
                                "Instantly search through your data with powerful query capabilities."
                            }
                        >
                            Local text search
                        </Tip>
    ...
    const proTier = (
        ...
        >
            <h3 className={"text-3xl md:text-4xl font-bold  text-gray-700 uppercase my-2"}>Pro</h3>
            <p className={"text-lg mb-4 font-bold h-16"}>
            ...
            <div className={"w-fit my-6 flex flex-row gap-2"}>
                <div
                    className={
                        "rounded-lg w-fit h-fit font-regular m-auto gap-1 text-ellipsis px-4 py-1.5 text-sm font-semibold"
                    }
                    style={{
                ...
                <a
                    className={clsx(
                        "btn px-4 py-2  uppercase rounded border-solid text-base dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-900 dark:hover:border-gray-800 "
                    )}
                    href="/pro"
                >
                    More info
            ...
            <div className={"grow"}>
                <ul className={"pl-4"}>
                    ...
                    <li className={"list-disc ml-2"}>
                        <Tip
                            tip={
                                "Implement tailored authentication methods and precise access controls."
                            }
                        >
                    ...
                    <li className={"list-disc ml-2"}>
                        <Tip
                            tip={
                                "Influence the development of future features through roadmap prioritization."
                            }
                        >
    ...
    return (
        <section
            className={clsx(
                defaultBorderMixin,
                "flex flex-col text-gray-900 items-center justify-center text-lg border-0 border-t bg-gray-100 z-10"
            )}
        >
            <div
                className={clsx(
                    ...
                    defaultBorderMixin,
                    "flex flex-col gap-8 border-r border-l border-t-0 border-b-0"
                )}
            >
                <div className={"max-w-4xl mx-auto"}>
                    <p className={"max-w-6xl mx-auto mt-0 mb-8"}>
                        <strong>FireCMS Cloud</strong> offers a complete, end-to-end solution for
                        businesses that require the highest level of support and security. With
                        dedicated hosting, advanced features, and expert support, you&#39;ll have
                        everything you need to take your project to the next level.
                    </p>
                </div>
                <div className="flex flex-col items-center md:grid md:grid-cols-3 gap-4 w-full mx-auto">
                    {communityTier}
                    {cloud}
                    {proTier}
                </div>
