...
export function ToggleButton({
    ...
    return (
        <div
            onClick={onClick}
            className={
                "cursor-pointer max-w-sm p-6 border border-solid rounded-lg flex flex-row gap-4 items-center bg-gray-50 " +
                (selected
        ...
        >
            ...
            <div className={"flex flex-col"}>
                <h3 className={"text-xl md:text-2xl font-bold mb-0"}>{title}</h3>
                <p className={"text-lg mb-0"}>{subtitle}</p>
            </div>
        </div>
    );
}
