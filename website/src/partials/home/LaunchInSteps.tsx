            ...
            <div className="w-full px-6 lg:px-12 py-16">
                <div className="flex justify-center w-full mb-8">
                    <div
                        role="tablist"
                        className={
                            "inline-flex space-x-1 rounded bg-black p-1 border " +
                            defaultBorderMixin
                        }
                    >
                        <button
                ...
                {selectedTab === "cloud" && (
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row justify-center items-start gap-10">
                            <div
                                className={
                                    "text-center md:text-left max-w-xs mx-auto  rounded-2xl p-8 mb-8 md:mb-0  border " +
                                    defaultBorderMixin
                                }
                            >
                                ...
                                <p className="text-sm text-gray-text-dark leading-relaxed">
                                    We will setup a Service Account for you and connect it to your
                                    project.
                                </p>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-text-dark leading-relaxed">
                                    Let FireCMS infer your data structure automatically or define it
                                    manually.
                                </p>
                            </div>
                            <div
                                className={
                                    "text-center md:text-left max-w-xs mx-auto  rounded-2xl p-8  border " +
                                    defaultBorderMixin
                                }
                            >
                                ...
                                <p className="text-sm text-gray-text-dark leading-relaxed">
                                    Access your fully functional, production-ready admin panel or
                                    CMS.
                                </p>
                            </div>
                        </div>
                ...
                {selectedTab === "self_hosted" && (
                    <div
                        className={
                            "w-full min-h-[450px] flex flex-col items-center justify-center gap-4 md:flex-row"
                        }
                    >
                        <StartHacking />
                    </div>
