...
function HeroButtons() {
    ...
    return (
        <div className="mt-8 mb-8 ">
            <div
                className={
                    "flex justify-center lg:flex-row flex-col-reverse items-center gap-4 px-4"
                }
            >
                <a
                    aria-label="Join our Discord"
                    className={
                        "btn shadow-none py-4 text-white dark:hover:bg-gray-900 hover:bg-gray-200 uppercase border border-solid w-full lg:w-auto rounded"
                    }
