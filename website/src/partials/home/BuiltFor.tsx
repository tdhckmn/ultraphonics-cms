                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    >
                        <div className={"p-6 rounded-xl border " + defaultBorderMixin}>
                            ...
                            <p className="text-sm text-white leading-relaxed">
                                Rapidly build internal tools, CRUD interfaces, and back-offices
                                without the frontend hassle. Focus on your core application logic.
                            </p>
                        </div>
                    </Link>
                    ...
                    >
                        <div className={"p-6 rounded-xl border " + defaultBorderMixin}>
                            ...
                            <p className="text-sm text-white leading-relaxed">
                                Get your MVP&#39;s admin panel or basic CMS running in minutes, not
                                weeks. Iterate quickly and manage your data efficiently.
                            </p>
                        </div>
                    </Link>
                    ...
                    >
                        <div className={"p-6 rounded-xl border " + defaultBorderMixin}>
                            ...
                            <p className="text-sm text-white leading-relaxed">
                                Deliver custom back-office solutions for clients faster and more
                                reliably on top of the scalable Google Cloud infrastructure.
                            </p>
                        </div>
                    </Link>
                    <Link
                    ...
                    >
                        <div className={"p-6 rounded-xl border " + defaultBorderMixin}>
                            ...
                            <p className="text-sm text-white leading-relaxed">
                                Best-in-class user experience for managing your data. FireCMS is
