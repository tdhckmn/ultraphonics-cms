                ...
                >
                    <div className={"relative max-w-6xl mx-auto pb-16 my-16"}>
                        ...
                        <div className={"mt-4 mx-auto text-xl"}>
                            <p>
                                FireCMS offers a streamlined data import feature designed to make
                                your life easier. Whether you&#39;re working with extensive{" "}
                                <b>CSV, JSON or Excel</b> files, our intuitive tools enable you to
                                transfer and integrate your datasets into FireCMS. No more tedious
                                manual data entry or convoluted import processes—just quick,
                                efficient, and reliable data importation.
                            </p>
                            <p>
                                Our data import tool will{" "}
                                <b>detect your data types automatically</b>, and if you override a
                                mapping, it will do the data conversion for you.
                            </p>
                        </div>
                    </div>
                </div>
