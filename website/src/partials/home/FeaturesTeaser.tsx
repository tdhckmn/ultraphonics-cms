                        ...
                        <div className={""}>
                            <div className={clsx("text-xl ")}>
                                <div className={"flex items-center mb-3"}>
                                    <h3 className="m-0 uppercase">Unmatched Editing Experience</h3>
                                </div>

                                <p className="text-xl md:text-2xl">
                                    FireCMS offers both flexibility and an excellent user
                                    experience. Edit your collections and entities using a
                                    user-friendly <b>spreadsheet view and effective forms</b>.
                                </p>
                            </div>
            ...
            <Panel color={"light"}>
                <TwoColumns
                    ...
                    right={
                        <div>
                            <div className={"flex items-center mb-3 "}>
                                <h3 className="m-0 uppercase">Flexible Customization</h3>
                            </div>
