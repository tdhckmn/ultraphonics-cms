...
function FeaturesPanels() {
    ...
    return (
        <Panel color={"light"} includePadding={false} container={false}>
            ...
            <div data-aos="fade-up" className={"flex items-center mb-4"}>
                <div className={"w-full"}>
                    <p className={clsx("max-w-6xl mx-auto text-xl md:text-2xl py-4 ")}>
                        FireCMS provides all the flexibility you need with the best UX. Edit your
                        collections and entities using both a <b>spreadsheet view</b> and{" "}
                        <b>powerful forms</b>.
                    </p>
                </div>
            </div>
            ...
            <div
                className={
                    "max-w-6xl flex flex-col lg:items-center gap-4 md:grid md:grid-cols-2 lg:grid-cols-3 lg:w-full lg:mx-auto p-4"
                }
            >
                <div
                    className={clsx(
                        "bg-white relative flex flex-col items-center p-6  rounded-2xl border border-solid",
                        defaultBorderMixin
                    )}
                >
                    {iconStars}
                    ...
                    <p className=" text-center">
                        FireCMS will automatically infer the data structure and types for you.
                    </p>
                </div>
            ...
            <div className="max-w-3xl mx-auto text-center py-8 md:py-12">
                <a className={CTAOutlinedButtonMixin + " mx-auto"} href={useBaseUrl("features/")}>
                    See all features
                    <CTACaret />
                </a>
            </div>
