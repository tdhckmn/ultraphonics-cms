    ...
    return (
        ...
        >
            <div className="mt-16 mx-auto flex row items-center justify-center gap-2">
                <span className="text-sm font-semibold bg-gray-700 text-white px-2 py-1 rounded">
                    MIT licensed
                </span>
            ...
            <div
                className={clsx(
                    "relative flex justify-center mb-8 border-b border-0",
                    defaultBorderMixin
                )}
            >
                <div className="flex flex-row gap-8 md:gap-12 justify-center items-center p-4">
                    <FirebaseLogo
                        style={{
                            width: 130,
                            height: 150,
            ...
            <div className="max-w-6xl mx-auto text-center mb-12 px-8 py-4 md:px-8">
                <h2 className="mb-4 uppercase m-auto">Much more than a CMS</h2>
                <p className="text-xl md:text-2xl">
                    <b>FireCMS</b> is a platform upon which thousands of companies build their{" "}
                    <b>back-office applications</b> and <b>admin panels</b>. Open-source, headless,
