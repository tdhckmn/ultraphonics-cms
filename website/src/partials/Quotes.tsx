...
export const QuotesSection: React.FC = () => {
    return (
        <Panel color={"lighter"} includePadding={false} container={false}>
            ...
            {/*    </script>*/}
            {/*</Head>*/}
            <div className="py-16 px-8 flex flex-row gap-4 overflow-auto no-scrollbar">
                {quotes.map(({ quote, avatar, author, role }, i) => (
                    <blockquote
                        ...
                        className={clsx(
                            "bg-white",
                            "flex flex-col",
                            "not-italic w-96 min-w-[380px] bg-gray-50 relative flex flex-col items-center justify-center px-8 py-6 rounded-2xl border",
                            defaultBorderMixin
                        )}
                    >
                        ...
                        <img
                            ...
                            alt={author}
                        />
                        <cite className="not-italic	block mt-4 text-sm font-bold uppercase text-center">
                            ~ {author}
                        </cite>
                        <cite className="not-italic	block mt-2 text-xs font-bold uppercase text-center">
                            {role}
                        </cite>
                    </blockquote>
                ))}
