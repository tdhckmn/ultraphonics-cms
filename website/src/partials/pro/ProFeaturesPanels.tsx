    ...
    return (
        ...
        >
            <div className={ContainerPaddingMixin}>
                <div data-aos="fade-up" className={"container flex items-center mb-4 "}>
                    <div className={"max-w-6xl mx-auto"}>
                        ...
                        <p className={clsx("text-xl md:text-2xl py-4")}>
                            <b>FireCMS PRO</b> gives you full access to all the features and
                            components of FireCMS, with the freedom to style and customize as you
                            like. Plus, it offers extra tools and elements to help you create
                            superior back-office applications/admin panels more efficiently. With
                            FireCMS PRO, you gain greater control and efficiency, enjoying a user
                            experience tailored for professionals. Take charge of your data with
                            advanced tools, including an easy-to-use{" "}
                            <strong className={"text-primary"}>spreadsheet view</strong> and{" "}
                            <strong className={"text-primary"}>dynamic, feature-rich forms</strong>.
                            It's the professional advantage your projects need.
                        </p>
                    </div>
                </div>
...
const iconStars = (
    <svg className="w-16 h-16 p-1" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
