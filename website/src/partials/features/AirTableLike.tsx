...
export function AirTableLike() {
    return (
        <>
            <Panel color={"light"}>
                <div className="max-w-6xl mx-auto text-center py-12 h-32"></div>
            </Panel>

            <Panel color={"lighter"}>
                <div className={ContainerMixin + " -translate-y-44"}>
                    <video
                        style={{
                            pointerEvents: "none",
                        }}
                ...
                <div
                    className={
                        "mx-auto md:col-span-9 md:pr-8 flex justify-center flex-col h-full mb-8 -mt-24"
                    }
                >
                    ...
                    <p className="text-xl ">
                        Inline editing is very useful when you want to quickly edit a few fields of
                        a document. For example, if you have a list of users, you can quickly edit
                        the name of the user by clicking on the name and editing it.
                    </p>
