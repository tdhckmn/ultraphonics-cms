...
export const SchemaEditorIntro = () => {
    return (
        <section className="relative bg-gray-900">
            <div
                className={clsx(
                    "px-4 sm:px-6 mb-16 bg-gray-700 text-white dark:text-white",
                    "border-0 border-y",
                    defaultBorderMixin
                )}
            >
                ...
                >
                    <div className={"relative max-w-6xl mx-auto mt-16"}>
                        ...
                        <div className={"mt-4 mx-auto text-xl pb-20"}>
                            <p>Edit your data schema with a powerful and intuitive interface.</p>
                            <p>
                                If you have an <strong>existing project</strong>, let FireCMS set-up
                                the collections for you, based on your data{" "}
                                <strong>automatically</strong>.
                            </p>
                            <p>
                                FireCMS is great both for existing projects, since it will adapt to
                                any database structure you have, as well as for new ones, since it
                                sets up a complete Google Cloud Project for you.
                            </p>
                        </div>
                    </div>
                </div>
