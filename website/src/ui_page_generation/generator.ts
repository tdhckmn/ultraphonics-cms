...
export async function generateUIPage() {
    ...
    const files = walk("./samples/components");
    //
    ...
    const stream = await openai.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "user",
                content: `Generate a new UI page for the marketing landing page. Use React, tailwind and typescript. You can import any of the components included in the instructions.
                It is very important that you include a bunch of sections. You MUST add at least one example of each component
                Just return the code, no explanations needed. Do not return triple ticks. just the code.
                When creating dialogs, make sure you are controlling the open or close state with a variable.
