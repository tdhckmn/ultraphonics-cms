        ...
        <div className={cls(className)}>
            ...
            <div className={cls("flex flex-row gap-4")}>
                <Tooltip title={"Documents are open in a side panel"}>
                    ...
                    >
                        <VerticalSplitIcon />
                        <Typography variant={"label"}>Side panel</Typography>
                    </Card>
                </Tooltip>
                ...
                <Tooltip title={"Documents are open full-screen"}>
                    ...
                    >
                        <SquareIcon />
                        <Typography variant={"label"}>Full screen</Typography>
                    </Card>
                </Tooltip>
            </div>
            <Typography variant={"caption"} color={"secondary"} className={"ml-3.5"}>
                Should documents be opened full screen or in an inline side dialog
            </Typography>
        </div>
    );
}
