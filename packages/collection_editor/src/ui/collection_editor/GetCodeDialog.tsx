...
export function GetCodeDialog({
    ...
    const code = collection
        ? 'import { EntityCollection } from "@firecms/core";\n\nconst ' +
          (collection?.name ? camelCase(collection.name) : "my") +
          "Collection:EntityCollection = " +
          JSON5.stringify(collectionToCode({ ...collection }), null, "\t")
        ...
        <Dialog open={open} onOpenChange={onOpenChange} maxWidth={"4xl"}>
            ...
            <DialogContent>
                <Typography variant={"body2"} className={"my-4 mb-8"}>
                    If you want to customise the collection in code, you can add this collection code to your CMS app
                    configuration. More info in the{" "}
                    <a rel="noopener noreferrer" href={"https://firecms.co/docs/cloud/quickstart"}>
                        docs
                    </a>
                    .
                </Typography>
