                ...
                >
                    <div className={"grid grid-cols-12 gap-2 p-4"}>
                        ...
                        <div className={"col-span-12"}>
                            ...
                            <Field name={storeUrl} type="checkbox">
                            ...
                            <Typography variant={"caption"} className={"ml-3.5 mt-1 mb-2"}>
                                Turn this setting on, if you prefer to save the download URL of the uploaded file
                                instead of the storage path. You can only change this prop upon creation.
                            </Typography>
                        </div>
