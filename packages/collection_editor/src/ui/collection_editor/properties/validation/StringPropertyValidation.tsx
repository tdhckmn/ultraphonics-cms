            ...
            <div className={"grid grid-cols-12 gap-2 col-span-12"}>
                {lowercase && (
                    <div className={"col-span-4"}>
                        <Field name={validationLowercase} type="checkbox">
                            {({ field, form }: FormexFieldProps) => {
                                return (
                                    <SwitchControl label={"Lowercase"} disabled={disabled} form={form} field={field} />
                                );
                            }}
                        </Field>
                    </div>
                ...
                {uppercase && (
                    <div className={"col-span-4"}>
                        <Field name={validationUppercase} type="checkbox">
                            {({ field, form }: FormexFieldProps) => {
                                return (
                                    <SwitchControl label={"Uppercase"} disabled={disabled} form={form} field={field} />
                                );
                            }}
                        </Field>
                    </div>
                ...
                {trim && (
                    <div className={"col-span-4"}>
                        <Field name={validationTrim} type="checkbox">
                            {({ field, form }: FormexFieldProps) => {
                                return <SwitchControl label={"Trim"} disabled={disabled} form={form} field={field} />;
                            }}
                        </Field>
                    </div>
                )}
