...
export function GeneralPropertyValidation({ disabled }: { required?: boolean; disabled: boolean }) {
    ...
    return (
        <>
            <div className={"col-span-6"}>
                <Field name={validationRequired} type="checkbox">
            ...
            <div className={"col-span-6"}>
                <Field name={validationUnique} type="checkbox">
                    {({ field, form }: FormexFieldProps) => {
                        return (
                            <SwitchControl
                                disabled={disabled}
            ...
            {getIn(values, validationRequired) && (
