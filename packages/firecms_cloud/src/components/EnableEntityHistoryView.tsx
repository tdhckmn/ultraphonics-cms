...
export function EnableEntityHistoryView({
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-8 gap-4">
            Enable the entity history in this collection to view the history of changes made to
            entities. This feature allows you to track modifications, additions, and deletions over
            time, providing a comprehensive audit trail for your data.
            <LoadingButton
                loading={loading}
                variant={"outlined"}
                disabled={enabled}
