        ...
        >
            ...
            <DialogContent className={"flex flex-col gap-4"}>
                    ...
                    <>
                        <div className={"flex flex-col gap-2 mb-2"}>
                            ...
                            <Typography variant={"caption"} className={"mt-4"}>
                                Note that enabling local text search will need to fetch all
                                documents from your collection and store them in the browser. This
                                can be inefficient for large collections. It can also incur in
                                additional costs.
                            </Typography>

                            <Typography variant={"caption"}>
                                For larger collections, you are encouraged to use an external search
                                engine such as Algolia or Elastic Search, and assign a search
                                delegate to your config.
                            </Typography>
                        </div>

                        <Typography>
                            Local text search is the simplest way to enable text search in your
                            collection. It loads all documents in the collection in the browser and
                            performs the search locally. This is the recommended option for small
                            collections.
                        </Typography>
                    </>
                )}
                ...
                {hasOwnTextSearchImplementation && (
                    <>
                        <Typography>
                            You have implemented your own text search controller. You enable text
                    ...
                    {!hasOwnTextSearchImplementation && !projectConfig.localTextSearchEnabled && (
                        <LoadingButton
                            ...
                            onClick={() => {
                                ...
                                projectConfig
                                    .updateLocalTextSearchEnabled(true)
                                    .then(async () => {
