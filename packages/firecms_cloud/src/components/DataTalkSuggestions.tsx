...
export function DataTalkSuggestions({
    ...
    return (
        <Collapse in={(suggestions ?? []).length > 0} className={"mt-4"}>
            <Typography
                variant={"body2"}
                color={"secondary"}
                className={"ml-2 flex items-center gap-2"}
            >
                <ForumIcon size="smallest" /> Query and update your data in natural language with{" "}
                <b>DATATALK</b>
            </Typography>
                        ...
                        return (
                            <Label
                                ...
                                onClick={() => {
                                    ...
                                    return navigate(
                                        navigation.homeUrl + "/datatalk?prompt=" + suggestion
                                    );
                                }}
                                key={index}
                            >
