...
export function FireCMSCloudLoginView({
    ...
    function buildErrorView() {
        ...
        if (
            ...
            !ignoredCodes.includes(fireCMSBackend.authProviderError.code)
        ) {
            errorView = (
                <div className={"p-4"}>
        ...
        <div className="flex flex-col items-center justify-center min-w-full p-2" style={fadeStyle}>
            ...
            {includeLogo && (
                <Typography variant={"h4"} color={"primary"} className="mb-4">
                    FireCMS{" "}
                    <Typography variant={"h4"} component={"span"} className={"text-blue-500"}>
                        CLOUD
                    </Typography>
                </Typography>
            )}
            ...
            {includeGoogleAdminScopes && fireCMSBackend.permissionsNotGrantedError && (
                <ErrorView
                    error={
                        "You need to grant additional permissions in order to manage your Google Cloud projects"
                    }
                />
            )}
            ...
            {includeGoogleDisclosure && (
                <Typography variant={"caption"}>
                    FireCMS Cloud use and transfer to any other app of information received from
