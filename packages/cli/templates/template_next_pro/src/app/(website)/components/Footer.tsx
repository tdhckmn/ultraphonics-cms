        ...
        <footer className="bg-white dark:bg-surface-900">
            <div className="mx-auto w-full max-w-screen-xl">
                <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-surface-900 uppercase dark:text-white">
                            Company
                        </h2>
            ...
            <div className={"flex flex-col gap-2 p-3 text-center"}>
                <a
                    className={"font-headers text-text-disabled text-sm font-medium uppercase"}
