    ...
    return (
        <div className={"w-full min-h-[80dvh]"}>
            ...
            >
                ...
                <CategoriesFilter value={categoryFilter} setValue={updateCategoriesFilter} />
            ...
            <div className={"mx-auto max-w-5xl my-8 p-4"}>
                ...
                {loading && (
                    <div className="text-center my-32 min-h-full">
...
function CategoriesFilter({
    ...
    return (
        <div>
            <div className="text-xs font-medium mb-2 text-surface-accent-500 dark:text-surface-accent-300 uppercase">
                Category:
            </div>
