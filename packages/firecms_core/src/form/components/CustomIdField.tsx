...
export function CustomIdField<M extends Record<string, any>>({
    ...
    const enumValues: EnumValueConfig[] | undefined = useMemo(() => {
        if (!customId || typeof customId === "boolean" || customId === "optional") return undefined;
        ...
        endAdornment: loading ? (
            ...
            <>
                <Tooltip title={"Copy"} asChild={true}>
                    <IconButton onClick={(e) => copy(entity.id)} aria-label="copy-id">
                        <ContentCopyIcon size={"small"} />
                    </IconButton>
                </Tooltip>

                {customizationController?.entityLinkBuilder && (
                    <Tooltip title={"Open in the console"} asChild={true}>
                        <IconButton
                            component={"a"}
        ...
        <>
            ...
            {!enumValues && (
                <TextField
                    ...
                    placeholder={
                        customId === "optional"
                            ? "Autogenerated ID, it can be manually changed"
