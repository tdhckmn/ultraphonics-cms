    ...
    return (
        <div
            className={cls(
                ...
                size === "large"
                    ? "min-w-[220px] min-h-[220px] max-w-[220px]"
                    : "min-w-[118px] min-h-[118px] max-w-[118px]",
                className
            )}
        >
            {!placeholder && !disabled && (
                <div className="absolute rounded-full -top-2 -right-2 z-10 bg-white dark:bg-surface-900">
                    <Tooltip asChild={true} title="Remove">
                        <IconButton
                            size={"small"}
                            onClick={(event) => {
