...
export function Tabs({ value, onValueChange, className, innerClassName, children }: TabsProps) {
    return (
...
export function Tab({ value, className, innerClassName, children, disabled }: TabProps) {
    return (
