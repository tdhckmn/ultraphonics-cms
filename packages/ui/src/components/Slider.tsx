...
function SliderThumb(props: {
    ...
    return (
        <TooltipPrimitive.Root open={props.hovered}>
            <TooltipPrimitive.Trigger asChild>
                <SliderPrimitive.Thumb
                    className={cls(
                        {
                            "border-primary bg-primary outline-none": !props.props.disabled,
                            "border-surface-accent-300 bg-surface-accent-300 dark:border-surface-700 dark:bg-surface-700":
            ...
            <TooltipPrimitive.Provider delayDuration={200}>
                ...
                >
                    <SliderPrimitive.Track
                        ...
                        className={
                            "relative w-full grow overflow-hidden rounded-full bg-surface-accent-300 bg-opacity-40 dark:bg-surface-700 dark:bg-opacity-40"
                        }
                    >
