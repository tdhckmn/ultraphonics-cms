    ...
    (
        ...
        return (
            ...
            >
                ...
                >
                    <SelectPrimitive.Trigger ref={inputRef} id={id} asChild>
                        <div
                            className={cls(
                                "h-full",
                                padding
                                ...
                                disabled
                                    ? "text-surface-accent-600 dark:text-surface-accent-400"
                                    : "text-surface-accent-800 dark:text-white",
                            ...
                            >
                                ...
                                >
                                    ...
                                    {hasValue &&
                                        ...
                                        (() => {
                                            // @ts-ignore
                                            const childrenProps: SelectItemProps[] = Children.map(
                                                children,
                                                (child) => {
                ...
                <SelectPrimitive.Portal>
                    <SelectPrimitive.Content
                        ...
                        className={cls(
                            focusedDisabled,
                            "z-50 relative overflow-hidden border bg-white dark:bg-surface-900 p-2 rounded-lg",
                            defaultBorderMixin
                        )}
                    >
                        <SelectPrimitive.Viewport
                            className={cls("p-1", viewportClassName)}
...
export function SelectItem<T extends SelectValue = string>({
    ...
    return (
        ...
        >
            ...
            <div className="absolute left-1 data-[state=checked]:block hidden">
                <CheckIcon size={16} />
            </div>
        </SelectPrimitive.Item>
    );
