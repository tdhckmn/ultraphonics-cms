...
export function Menubar({
    ...
    return (
        <MenubarPrimitive.Root
            onSelect={onSelect}
            className={cls(
                "z-10 flex bg-white dark:bg-surface-950 p-[3px] rounded-sm shadow-sm",
                className
            )}
        >
            {children}
...
export function MenubarTrigger({
    ...
    return (
        <MenubarPrimitive.Trigger
            onSelect={onSelect}
            className={cls(
                "py-2 px-3 outline-none select-none font-medium leading-none rounded text-text-primary dark:text-text-primary-dark text-[13px] flex items-center justify-between gap-[2px] data-[highlighted]:bg-surface-accent-100 data-[highlighted]:dark:bg-surface-800 data-[state=open]:bg-surface-accent-100 data-[state=open]:dark:bg-surface-800 hover:bg-surface-accent-200 hover:bg-opacity-75 dark:hover:bg-surface-accent-800",
                className
            )}
        >
            {children}
    ...
    return (
        <MenubarPrimitive.Item
            ...
            className={cls(
                ...
                leftPadding ? "pl-5" : "",
                disabled
                    ? "pointer-events-none text-text-secondary dark:text-text-secondary-dark"
...
export function MenubarSub({ children, ...rest }: { children?: React.ReactNode }) {
...
export function MenubarItemIndicator({
    ...
    return (
        <MenubarPrimitive.ItemIndicator
            className={cls(
                "absolute left-0 w-4 inline-flex items-center justify-center",
                className
            )}
            {...rest}
        >
...
export function MenubarShortcut({
    ...
    return (
        <div
            className={cls(
                "ml-auto pl-5 group-data-[disabled]:text-text-disabled data-[disabled]:dark:text-text-disabled-dark",
                className
            )}
            {...rest}
        >
