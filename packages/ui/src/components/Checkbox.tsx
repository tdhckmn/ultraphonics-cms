        ...
        >
            <div
                className={cls(
                    ...
                    onCheckedChange
                        ? "rounded-full hover:bg-surface-accent-200 hover:bg-opacity-75 dark:hover:bg-surface-accent-700 dark:hover:bg-opacity-75"
                        : "",
            ...
            >
                <div
                    className={cls(
                        ...
                        indeterminate || isChecked
                            ? "text-surface-accent-100 dark:text-surface-accent-900"
                            : "",
                        disabled
                            ? "border-transparent"
                            : indeterminate || isChecked
