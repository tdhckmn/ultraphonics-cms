 ...
 */
export const HighlightDecorationExtension = (initialHighlight?: HighlightRange) =>
    Extension.create<HighlightDecorationOptions>({
                ...
                new Plugin<AutocompleteHighlightState>({
                    ...
                    state: {
                        init: (_, { doc }) => {
                            ...
                            const decorationSet =
                                highlight && doc
                                    ? buildDecorationSet(highlight, doc)
                                    : DecorationSet.empty;
                            return {
                                decorationSet,
                                highlight,
        ...
        addCommands() {
            return {
                toggleAutocompleteHighlight:
                    (range?: { from: number; to: number }): Command =>
                    ({ state, dispatch }) => {
