...
export const appleIcon = (mode: "light" | "dark") => (
    <svg
        width={32}
        height={32}
        viewBox="0 0 56 56"
    ...
    >
        <g stroke={mode === "light" ? "#424245" : "white"} strokeWidth="0.5" fillRule="evenodd">
            <path
...
export const githubIcon = (mode: "light" | "dark") => (
    <svg
...
export const facebookIcon = (mode: "light" | "dark") => (
...
export const microsoftIcon = (mode: "light" | "dark") => (
...
export const twitterIcon = (mode: "light" | "dark") => (
