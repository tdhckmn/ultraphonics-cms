...
export function FirebaseLoginView({
    ...
    function buildErrorView() {
        ...
        if (authController.authProviderError) {
            if (
                authController.authProviderError.code === "auth/operation-not-allowed" ||
                    ...
                    <>
                        <div className="p-4">
                            <ErrorView
                                ...
                                error={
                                    "You need to enable Firebase Auth and the corresponding login provider in your Firebase project"
                                }
                            />
                        </div>
                        {firebaseApp && (
                ...
                errorView = (
                    <div className="p-4">
                        <ErrorView
                            ...
                            error={
                                "auth/invalid-api-key: Check that your Firebase config is set correctly in your `firebase_config.ts` file"
                            }
                        />
                    </div>
                );
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center w-full max-w-[500px]">
                <div className="p-1 w-64 h-64 m-4">{logoComponent}</div>
                ...
                {!passwordLoginSelected && !phoneLoginSelected && (
                    <div className={"my-4 w-full"}>
                        {buildOauthLoginButtons(
                            authController,
                            resolvedSignInOptions,
                            modeState.mode,
                            disabled
                        )}
    ...
    return (
        <div className="my-1 w-full">
            <Button
                ...
                onClick={onClick}
            >
                <div className="p-1 flex h-8 items-center justify-items-center">
                    <div className="flex flex-col w-8 items-center justify-items-center">
                        {icon}
                    </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className={"flex flex-col gap-1"}>
                ...
                <TextField
                    ...
                    value={phone ?? ""}
                    disabled={Boolean(
                        phone && (authController.authLoading || authController.confirmationResult)
                    )}
                    type="phone"
    ...
    return (
        <form className={"w-full"} onSubmit={handleSubmit}>
            <div className={"max-w-[480px] w-full flex flex-col gap-4"}>
                ...
                <div>{loginState === "registration" && noUserComponent}</div>
                ...
                {(loginState === "email" || loginState === "registration") && (
                    <TextField
                        placeholder="Email"
                        autoFocus
                        value={email ?? ""}
                    ...
                    <div className={"flex flex-col gap-4 p-4"}>
                        <div>
                            ...
                            <Typography variant={"body2"}>
                                You can use one of these methods to login with {email}
                            </Typography>
                        </div>
