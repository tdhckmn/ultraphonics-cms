                    ...
                    <div className="hidden md:flex flex-col gap-3 items-start">
                        {product.images?.map((image, index) => (
                            <button
                                ...
                                className={cls(
                                    "border hover:border-surface-900 rounded-lg overflow-hidden transition-colors dark:hover:border-surface-50",
                                    defaultBorderMixin
                                )}
                            >
                                <StorageImage
                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-0.5">
                                    ...
                                    <StarIcon className="w-5 h-5 fill-blue-500 stroke-blue-500" />
                                    <StarIcon className="w-5 h-5 fill-blue-500 stroke-blue-500" />
                                    <StarIcon className="w-5 h-5 fill-blue-100 dark:fill-blue-900 stroke-blue-400 dark:stroke-blue-600" />
                                </div>
                            </div>
                        </div>
                        <div className="text-4xl font-semibold ml-auto">
