...
export default function ClientUIComponentsShowcase({
    ...
    const cardClasses =
        "relative p-4 mb-6 flex flex-col gap-2 break-inside-avoid dark:bg-surface-900 dark:bg-opacity-50";
        ...
        <div className={"max-w-6xl mx-auto "}>
            ...
            <div className="md:columns-2 lg:columns-3 gap-4">
                ...
                <Card className={cardClasses}>
                    ...
                    <Alert color="success" action={<Button size="small">Undo</Button>}>
                        Alert with action
                    </Alert>
                </Card>
                ...
                <Card className={cardClasses}>
                    ...
                    <div className={"flex flex-row flex-wrap gap-2"}>
                        ...
                        <Chip colorScheme="blueDarker" size="small">
                            Small Chip
                        </Chip>
                ...
                <Card className={cardClasses}>
                    ...
                    <Menu trigger={<Button variant={"outlined"}>Open Menu</Button>}>
                        <MenuItem onClick={() => alert("Menu Item 1 clicked")}>
                            Menu Item 1
                        </MenuItem>
                        <MenuItem onClick={() => alert("Menu Item 2 clicked")}>
                            Menu Item 2
                        </MenuItem>
                        <MenuItem onClick={() => alert("Menu Item 3 clicked")}>
                            Menu Item 3
                        </MenuItem>
                    </Menu>
                </Card>
                ...
                <Card className={cardClasses}>
                    ...
                    >
                        ...
                        <SelectItem key="tea" value="tea">
                            Tea
                        </SelectItem>
                        <SelectItem key="juice" value="juice">
                            Juice
                        </SelectItem>
                        <SelectItem key="soda" value="soda">
                            Soda
                        </SelectItem>
                ...
                <Card className={cardClasses}>
                    ...
                    <Badge color="primary" invisible={!badgeDisplayed}>
                        <Button
                            size={"small"}
                            variant={"outlined"}
                            onClick={() => {
                    ...
                    <Badge color="secondary" invisible={!badgeDisplayed}>
                        <span className="p-2">Secondary Badge</span>
                    </Badge>
                </Card>
                ...
                <Card className={cardClasses}>
                    ...
                    <Collapse in={isCollapseOpen}>
                        <div className="flow-root p-4 rounded-lg bg-blue-100 dark:bg-blue-950">
